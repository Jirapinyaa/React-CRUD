...
export default function BookList() {
  ...
  useEffect(() => {
    axios
      .get("https://node57336-daienv-8730375.proen.app.ruk-com.cloud/books")
      .then((response) => {
  ...
  const viewBook = (id) => {
    axios
      .get(`https://node57336-daienv-8730375.proen.app.ruk-com.cloud/books/${id}`)
      .then((response) => {
  ...
  const deleteBook = (id) => {
    axios
      .delete(`https://node57336-daienv-8730375.proen.app.ruk-com.cloud/books/${id}`)
      .then(() => {
